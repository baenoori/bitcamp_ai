...
# np.save(np_path + 'keras45_02_x_test.npy', arr=xy_test[0][0])
# np.save(np_path + 'keras45_02_y_test.npy', arr=xy_test[0][1])
...
# np.save(np_path + 'keras45_02_x_train.npy', arr=x_train)
# np.save(np_path + 'keras45_02_y_train.npy', arr=y_train)
# np.save(np_path + 'keras45_02_x_test.npy', arr=x_test)
# np.save(np_path + 'keras45_02_y_test.npy', arr=y_test)
