...
print(x_train.shape, y_train.shape) # (128, 200, 200, 3) (128,)
print(x_test.shape, y_test.shape)   # (32, 200, 200, 3) (32,)
# 데이터 걸린시간 : 71.87 초
...
filepath = "".join([path, 'k41_3_', date, '_', filename])   
#####################################
