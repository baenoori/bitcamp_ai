...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(16, 2, activation='relu', input_shape=(8,1)))
model.add(Flatten())
...
[LSTM]
loss : 0.3826203942298889
r2 score :  0.7056784020616906

[Conv1D]
loss : 0.2933720648288727
r2 score :  0.7743304750730133
