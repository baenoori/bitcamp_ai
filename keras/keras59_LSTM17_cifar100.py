...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPooling2D, LSTM, Bidirectional
import time
...
#2. 모델 구성 
model = Sequential()
model.add(Bidirectional(LSTM(64, input_shape=(32*32,3), return_sequences=True)))
...
loss : 2.4463982582092285
acc : 0.38
accuracy_score : 0.3754
걸린 시간 : 300.29 초

[LSTM]
loss : 2.9435503482818604
acc : 0.29
accuracy_score : 0.2888
걸린 시간 : 949.77 초
