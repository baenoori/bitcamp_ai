...
train_datagen =  ImageDataGenerator(
    ...
    # shear_0range=0.7,             # 좌표 하나를 고정시키고 다른 몇개의 좌표를 이동시키는 변환 (찌부시키기)
...
x_augmented = train_datagen.flow(
    ...
    shuffle=False,
    save_to_dir='C:/ai5/_data/_save_img/06_man_woman/'
).next()[0]
...
filepath = "".join([path, 'k49_06_2_2_', date, '_', filename])   
#####################################
...
[데이터 증폭]
loss : 0.17263691127300262
acc : 0.93854
걸린 시간 : 275.04 초
accuracy_score : 0.9385351490614648

[여자 데이터만 증폭]
loss : 0.19534070789813995
acc : 0.93081
걸린 시간 : 189.17 초
accuracy_score : 0.930806036069194

[증폭 데이터 세이브(검수-상하좌우반전 제거)]
loss : 0.18911400437355042
acc : 0.9297
걸린 시간 : 194.59 초
accuracy_score : 0.9297018770702982
