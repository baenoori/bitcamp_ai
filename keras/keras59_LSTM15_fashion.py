...
#2. 모델 구성 
model = Sequential()
model.add(Bidirectional(LSTM(32, input_shape=(28,28), return_sequences=True)))
...
filepath = "".join([path, 'k59_01_', date, '_', filename])   
#####################################
...
[LSTM]
loss : 0.2899182438850403
acc : 0.9
accuracy_score : 0.8992
걸린 시간 : 234.72 초
