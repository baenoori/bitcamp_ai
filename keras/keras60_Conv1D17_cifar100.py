...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPooling1D, LSTM, Bidirectional, Conv1D
import time
...
#2. 모델 구성 
model = Sequential()
model.add(Conv1D(64, 3, input_shape=(32*32,3)))
