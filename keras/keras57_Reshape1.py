...
model.add(Reshape(target_shape=(28,28,10)))  # (N, 28, 28, 10)   # target shape 은 input shape와 동일하게 
...
model.add(Reshape(target_shape=(10*10*5,)))    # (500,) flatten과 동일한 결과
...
filepath = "".join([path, 'k57_1_', date, '_', filename])   
#####################################
