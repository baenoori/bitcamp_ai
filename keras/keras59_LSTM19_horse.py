...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Dropout, MaxPooling1D, Bidirectional, LSTM
import time
...
print(x_train.shape, x_test.shape) #  (10821, 200, 200, 3) (10821,)
...
#2. 모델 구성
model = Sequential()
model.add(Bidirectional(LSTM(32, input_shape=(200,200*3), activation='relu', return_sequences=True)))
