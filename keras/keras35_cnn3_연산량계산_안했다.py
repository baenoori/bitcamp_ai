...
model.add(Conv2D(10, (2,2), input_shape=(28,28,1)))     # (27,27,10)
                            # shape = (batch_size, rows, colums, channels)  -> batch_size : 전체 데이터에서 훈련 시킬 데이터의 개수
                            # shape = (batch_size, heights, widths, channels)
model.add(Conv2D(filters=20, kernel_size=(3,3)))        # (25,25,10)
...
#  flatten (Flatten)           (None, 7260)              0          # 연산량 없음 !! 
...
[gpu]
loss : 0.6024057269096375
acc : 0.85
r2 score : 0.7433763572091688
걸린 시간 : 3.55 초

[cpu]
loss : 0.7140191197395325
acc : 0.84
r2 score : 0.7240642063939976
걸린 시간 : 13.52 초
"""
