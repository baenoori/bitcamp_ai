...
### PCA  <- 비지도 학습 
pca = PCA(n_components=4)   # 4개의 컬럼이 3개로 바뀜
...
print(evr)  # [0.72944865 0.22881648 0.03624461]
print(sum(evr)) # 0.9945097426678959, <-- 1이 안됨 : 손실이 좀 있음 

# (120, 4) (30, 4)
# model.score : 1.0
# [0.72944865 0.22881648 0.03624461 0.00549026]
# 1.0000000000000002
