...
print(x_train1.shape)   # (142, 9)
print(x_train2.shape)   # (142, 1)
print(x_test1.shape)    # (36, 9)
print(x_test2.shape)    # (36, 1)

x_train = np.concatenate([x_train1, x_train2], axis=1)
x_test = np.concatenate([x_test1, x_test2], axis=1)

print(x_train.shape)    # (142, 10)
print(x_test.shape)     # (36, 10)
