...
print(x_train1.shape)   # (455, 22)
print(x_train2.shape)   # (455, 1)
print(x_test1.shape)    # (114, 22)
print(x_test2.shape)    # (114, 1)

x_train = np.concatenate([x_train1, x_train2], axis=1)
x_test = np.concatenate([x_test1, x_test2], axis=1)

print(x_train.shape)    # (455, 23)
print(x_test.shape)     # (114, 23)
