...
for i in range(len(num)): 
    ...
    path = './_save/ml05/04_dacon_darrung/'
    ...
    start = time.time()
    hist = model.fit(x_train1, y_train, epochs=5000, batch_size=16,
            verbose=0, 
...
# PCA : 1
# acc : 0.0
# r2 score : 0.049881045993085404
# 걸린 시간 : 4.26 초
# ===============================================
# 결과 2
# PCA : 3
# acc : 0.0
# r2 score : 0.5236329069221183
# 걸린 시간 : 13.49 초
# ===============================================
# 결과 3
# PCA : 9
# acc : 0.0
# r2 score : 0.6844892801895528
# 걸린 시간 : 8.93 초
# ===============================================
