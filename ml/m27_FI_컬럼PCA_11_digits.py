...
print(x_train1.shape)   # (1437, 48)
print(x_train2.shape)   # (1437, 1)
print(x_test1.shape)    # (360, 48)
print(x_test2.shape)    # (360, 1)

x_train = np.concatenate([x_train1, x_train2], axis=1)
x_test = np.concatenate([x_test1, x_test2], axis=1)

print(x_train.shape)    # (1437, 49)
print(x_test.shape)     # (360, 49)
