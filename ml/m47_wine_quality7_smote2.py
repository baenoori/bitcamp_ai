...
x_train, x_test, y_train, y_test = train_test_split(x, y, random_state=5437, test_size=0.2)

from imblearn.over_sampling import SMOTE
smote = SMOTE(random_state=5424)
...
smote - 3개로 줄인거 
acc : 0.7263636363636363
F1 : 0.7197822996142325
