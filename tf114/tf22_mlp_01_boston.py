...
w1 = tf.compat.v1.Variable(tf.random_normal([13,512], name='weight1'))     # hidden node 10개로
...
print('r2_score :', r2) # r2_score : -5010808.720446849
print('mae :', mae)     # mae : 15643.41387867647
