...
w1 = tf.compat.v1.Variable(tf.random_normal([8,512], name='weight1'))     # hidden node 10개로
...
print('r2_score :', r2) # r2_score : -9993410525.810928
print('mae :', mae)     # mae : 77871.86895027389
