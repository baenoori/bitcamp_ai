...
w1 = tf.compat.v1.Variable(tf.random_normal([9,512], name='weight1'))     # hidden node 10개로
...
print('r2_score :', r2) # r2_score : --827170.5077633349
print('mae :', mae)     # mae : 31387.43536265766
