...
test_loader = DataLoader(test_set, batch_size=512, shuffle=False)    # TEST셋은 shuffle X
...
# loss : 0.3393475259082359
# acc_score : 0.8647378747719527
# acc_score : 0.864737874771952