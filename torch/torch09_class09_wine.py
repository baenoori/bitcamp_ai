...
print(x_train.shape, x_test.shape)  # torch.Size([133, 13]) torch.Size([45, 13])  
print(y_train.shape, y_test.shape)  # torch.Size([133]) torch.Size([45])
