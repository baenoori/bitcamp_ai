...
print("========================================")
print(x_train.shape, x_test.shape)  # torch.Size([18576, 8]) torch.Size([2064, 8])
print(y_train.shape, y_test.shape)  # torch.Size([18576, 1]) torch.Size([2064, 1])
...
# 최종 loss : 0.5653049349784851
# r2_score : 0.5711399912834167
