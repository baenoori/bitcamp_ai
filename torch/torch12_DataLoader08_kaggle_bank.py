...
x = train_csv.drop(['CustomerId', 'Surname', 'Exited'], axis=1).values
...
print("========================================")
print(x_train.shape, x_test.shape)  # torch.Size([148530, 10]) torch.Size([16504, 10])
print(y_train.shape, y_test.shape)  # torch.Size([148530, 1]) torch.Size([16504, 1])
...
test_loader = DataLoader(test_set, batch_size=128, shuffle=False)    # TEST셋은 shuffle X
...
# 최종 loss : 19.7782851817996
# acc_score : 0.8645176926805623
# acc_score : 0.8645176926805623
