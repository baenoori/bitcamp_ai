...
print(x_train.shape, x_test.shape)  # torch.Size([1617, 64]) torch.Size([180, 64]) 
print(y_train.shape, y_test.shape)  # torch.Size([1617]) torch.Size([180])
