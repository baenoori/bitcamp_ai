...
class RNN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.contiguous()
        x = x.view(-1, 3*32*2)  # *2 안해주면 biditrctonal 인식 x
        x = self.fc1(x)
...
# epoch : 980, loss : 0.00566431332981665
# epoch : 1000, loss : 0.006052960015949793
# ================
# [[10.369468]]

print(f"{x_predict} 의 예측값 : {y_pre[0][0]}")     # [[ 8  9 10]] 의 예측값 : 10.369467735290527
